...
public class DBService {
	...
	Todo t2 = new Todo(null, "Ler", "Ler livro de desenvolvimento de software", LocalDateTime.parse("05/06/2023 15:00", formatter) , false);
	Todo t3 = new Todo(null, "Exercicios", "Praticar exerrcicios", LocalDateTime.parse("05/06/2023 16:00", formatter) , false);
	Todo t4 = new Todo(null, "Meditar", "Meditar durante 30 minutos", LocalDateTime.parse("05/06/2023 17:00", formatter) , false);
